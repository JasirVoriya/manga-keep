...
**Project:** 知音漫客收藏册
**Generated:** 2026-05-19 00:27:01
**Category:** Manga Collection App
...
| Secondary | `#E11D48` | `--color-secondary` |
| CTA/Accent | `#F97316` | `--color-cta` |
| Background | `#FFF7ED` | `--color-background` |
| Text | `#3B1D12` | `--color-text` |

**Color Notes:** Warm paper cream + manga rose + bookshelf brown
